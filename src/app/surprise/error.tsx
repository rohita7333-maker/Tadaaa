...
export default function SurpriseError({
  ...
  return (
    <div className="min-h-screen bg-[#FFF8F0] flex flex-col items-center justify-center px-6 text-center">
      ...
      <p className="text-[#6B5E57] mb-8 max-w-sm">
      ...
      <div className="flex gap-3">
        <button
          onClick={() => reset()}
          className="inline-flex items-center gap-2 bg-gradient-to-r from-[#C4686D] to-[#9B3D42] text-white px-6 py-3 rounded-full font-medium hover:opacity-90"
        >
          Try again
        </button>
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-6 py-3 rounded-full font-medium border border-[#D4CBC3] text-[#2D2926] hover:bg-white"
        >
