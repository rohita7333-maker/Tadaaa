...
// Curated list of common disposable/temp-mail domains, kept in sync with
// web src/lib/schemas.ts. Exact-match against the domain only (never a
...
// stored verbatim inside the invites.events jsonb column (same shape the web
// app writes, so both from-invite adapters read it unchanged).
