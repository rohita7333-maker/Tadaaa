// Curated invite templates — named presets bundling an occasion, a theme and
// a reveal style. Ids in the data must stay valid against themes.ts
// (occasions + themes); templates.test.ts enforces the cross-references,
// including tier === theme.isPremium.
...
export interface Template {
  ...
  /** Absent for v1 — cards fall back to the theme's CSS gradient. */
  art?: TemplateArt;
}
